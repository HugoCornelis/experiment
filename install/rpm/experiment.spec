...
%description
The Experiment package defines software components to run virtual experiments with GENESIS 3 neuronal simulator.  See the GENESIS 3 documentation available at http://www.genesis-sim.org/ for more information.
